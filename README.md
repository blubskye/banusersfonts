...
- Scan the entire server while **editing a single message** for all progress updates (no chat spam — I keep everything neat and pretty for you~)
- Ban (or report in dry-run) all the impurities in safe batches
- Update that same message with the final summary when I'm done
...
*Yuno approves this message... and will eliminate anyone who doesn't~ 🩸*# 💖🔪 Yuno's Perfect Font Enforcer Bot 💕🩸✨
### *Protecting our server from ugly fonts and dirty foreign letters... with all my love~*
